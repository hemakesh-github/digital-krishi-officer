...
export default function DiseaseResult() {
        ...
        return (
            <div className="min-h-screen bg-linear-to-br from-rose-50 to-red-50 font-sans">
                <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-16 sm:pt-20 flex flex-col items-center gap-4 text-center">
                    ...
                    <p className="text-gray-400 text-sm">Please go back and select a query from History.</p>
                    <button
    ...
    const handleGetAdvice = () => {
        navigate('/chat', { state: { crop: data.crop, diseaseName } })
    }
        ...
        <div className="min-h-screen bg-linear-to-br from-rose-50 via-red-50 to-orange-50 font-sans">
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-6 sm:pt-8 pb-16 flex flex-col gap-4 sm:gap-5">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl sm:text-2xl font-extrabold text-gray-900 tracking-tight">Disease Prediction Result</h1>
                ...
                <div className="bg-white rounded-2xl shadow-md overflow-hidden">
                    <div className="bg-gray-100 flex items-center justify-center h-52 sm:h-72 relative">
                        {data.imageUrl ? (
                            ...
                            <div className="flex flex-col items-center gap-3 text-gray-400">
                                ...
                                <p className="text-xs text-gray-300">Image storage coming with API integration</p>
                            </div>
                        )}
                    ...
                    <div className="p-4 sm:p-5 flex flex-col gap-4">
                        ...
                        {/* Disease name */}
                        <div>
                            <div className="text-[11px] font-semibold text-gray-400 uppercase tracking-wide mb-1">Detected Disease</div>
                            <div className="text-lg sm:text-xl font-extrabold text-gray-900">{diseaseName}</div>
                        </div>
                        ...
                        {confidence !== null && (
                            <div>
                                <div className="flex items-center justify-between mb-1.5">
                                    <span className="text-[11px] font-semibold text-gray-400 uppercase tracking-wide">Confidence</span>
                        ...
                        <div className="bg-rose-50 border border-rose-100 rounded-xl px-4 py-3 text-sm text-gray-700 leading-relaxed">
                            <span className="font-semibold text-rose-600">AI Result: </span>
                            {data.result}
                        </div>
                    </div>
                </div>

                {/* Get Advice CTA — stacks on mobile */}
                <div className="bg-white rounded-2xl shadow-md p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                    <div>
                        <div className="font-bold text-gray-800 text-sm">Need treatment advice?</div>
                        <div className="text-xs text-gray-400 mt-0.5">
                            Get expert recommendations for <span className="font-semibold text-green-700">{diseaseName}</span> on {data.crop}
                        </div>
                    </div>
                    <button
                        onClick={handleGetAdvice}
                        className="w-full sm:w-auto shrink-0 flex items-center justify-center gap-2 px-5 py-2.5 bg-green-600 hover:bg-green-700 active:scale-95 text-white font-semibold text-sm rounded-xl transition-all duration-150 cursor-pointer border-none shadow-sm shadow-green-200"
                    >
                        🌿 Get Advice
                    </button>
                </div>
